...
Run this after a session to generate graphs from the CSV log.

Usage:
    python generate_graphs.py                        # picks latest CSV automatically
    python generate_graphs.py test_log_20240101.csv  # specific file
"""
...
def load_csv(path=None):
    ...
    # Auto-pick the most recent log file
    files = glob.glob("test_log_*.csv")
    if not files:
        print("No test_log_*.csv files found in current directory.")
        sys.exit(1)
